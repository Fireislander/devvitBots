# Privacy Policy for nflgdtbot

**Effective Date:** May 27, 2026

Welcome to **nflgdtbot** (the "Bot"), an automated assistant built on the Reddit Devvit platform to manage National Football League (NFL) Game Day Threads (GDT) and Post-Game Threads (PGT) on Reddit. 
...
*   **Selected NFL Team:** The team for which the bot should generate game threads.
...
The Bot fetches real-time scores, team stats, play-by-play, and injury reports from public ESPN APIs (`https://site.api.espn.com` and `https://site.web.api.espn.com`). **No user data is ever sent to these services.**
